  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-gray-900 border border-white/[0.1] shadow-xl shadow-black/40",
        "text-sm text-white",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-lg px-3 py-2 text-sm text-gray-200",
      "outline-none focus:bg-indigo-600/20 focus:text-indigo-200",
      "data-[highlighted]:bg-indigo-600/20 data-[highlighted]:text-indigo-200",
